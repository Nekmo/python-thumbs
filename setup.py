...
PACKAGE_NAME = 'python-thumbs'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/python-thumbs/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/python-thumbs'
STATUS_LEVEL = 3  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['file', 'thumbs', 'generate', 'thumbnails']  # Palabras clave
...
PYTHON_VERSIONS = ['2.6-2.7', '3.2-3.5']
